...
import { ElementDefinition, String } from "../../resources/ts/proto/r4/core/datatypes_pb";
...
const Editor: React.FC<{}> = () => {
    ...
    return (
        <div>
            ...
            <a href={'data:json/plain;charset=utf-8,' + encodeURIComponent(JSON.stringify(profile, null, 2))} download={profile.name + '.json'}>
