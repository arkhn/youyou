...
// file: proto/r4/core/resources/communication.proto
...
export class Communication extends jspb.Message {
  ...
  hasStatus(): boolean;
  clearStatus(): void;
  getStatus(): Communication.StatusCode | undefined;
  setStatus(value?: Communication.StatusCode): void;
...
export namespace Communication {
  ...
  export class Payload extends jspb.Message {
    ...
    hasContent(): boolean;
    clearContent(): void;
    getContent(): Communication.Payload.ContentX | undefined;
    setContent(value?: Communication.Payload.ContentX): void;
