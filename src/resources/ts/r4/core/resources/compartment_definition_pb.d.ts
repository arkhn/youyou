...
// file: proto/r4/core/resources/compartment_definition.proto
...
export class CompartmentDefinition extends jspb.Message {
  hasId(): boolean;
  clearId(): void;
  ...
  hasStatus(): boolean;
  clearStatus(): void;
  getStatus(): CompartmentDefinition.StatusCode | undefined;
  setStatus(value?: CompartmentDefinition.StatusCode): void;
  ...
  hasCode(): boolean;
  clearCode(): void;
  getCode(): CompartmentDefinition.CodeType | undefined;
  setCode(value?: CompartmentDefinition.CodeType): void;

  hasSearch(): boolean;
  clearSearch(): void;
  getSearch(): proto_r4_core_datatypes_pb.Boolean | undefined;
  setSearch(value?: proto_r4_core_datatypes_pb.Boolean): void;

  clearResourceList(): void;
  getResourceList(): Array<CompartmentDefinition.Resource>;
  setResourceList(value: Array<CompartmentDefinition.Resource>): void;
  addResource(value?: CompartmentDefinition.Resource, index?: number): CompartmentDefinition.Resource;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CompartmentDefinition.AsObject;
  static toObject(includeInstance: boolean, msg: CompartmentDefinition): CompartmentDefinition.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: CompartmentDefinition, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CompartmentDefinition;
  static deserializeBinaryFromReader(message: CompartmentDefinition, reader: jspb.BinaryReader): CompartmentDefinition;
}

export namespace CompartmentDefinition {
  export type AsObject = {
    ...
    status?: CompartmentDefinition.StatusCode.AsObject,
    ...
    code?: CompartmentDefinition.CodeType.AsObject,
    search?: proto_r4_core_datatypes_pb.Boolean.AsObject,
    resourceList: Array<CompartmentDefinition.Resource.AsObject>,
  }
  ...
  export class Resource extends jspb.Message {
    ...
    hasCode(): boolean;
    clearCode(): void;
    getCode(): CompartmentDefinition.Resource.CodeType | undefined;
    setCode(value?: CompartmentDefinition.Resource.CodeType): void;

    clearParamList(): void;
    getParamList(): Array<proto_r4_core_datatypes_pb.String>;
    setParamList(value: Array<proto_r4_core_datatypes_pb.String>): void;
    addParam(value?: proto_r4_core_datatypes_pb.String, index?: number): proto_r4_core_datatypes_pb.String;
  ...
  export namespace Resource {
    export type AsObject = {
      ...
      extensionList: Array<proto_r4_core_datatypes_pb.Extension.AsObject>,
      modifierExtensionList: Array<proto_r4_core_datatypes_pb.Extension.AsObject>,
      code?: CompartmentDefinition.Resource.CodeType.AsObject,
      paramList: Array<proto_r4_core_datatypes_pb.String.AsObject>,
