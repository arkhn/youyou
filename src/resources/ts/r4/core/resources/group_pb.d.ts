...
// file: proto/r4/core/resources/group.proto
...
export class Group extends jspb.Message {
  ...
  hasType(): boolean;
  clearType(): void;
  getType(): Group.TypeCode | undefined;
  setType(value?: Group.TypeCode): void;

  hasActual(): boolean;
  clearActual(): void;
  getActual(): proto_r4_core_datatypes_pb.Boolean | undefined;
  setActual(value?: proto_r4_core_datatypes_pb.Boolean): void;
  ...
  hasQuantity(): boolean;
  clearQuantity(): void;
  getQuantity(): proto_r4_core_datatypes_pb.UnsignedInt | undefined;
  setQuantity(value?: proto_r4_core_datatypes_pb.UnsignedInt): void;

  hasManagingEntity(): boolean;
  clearManagingEntity(): void;
  getManagingEntity(): proto_r4_core_datatypes_pb.Reference | undefined;
  setManagingEntity(value?: proto_r4_core_datatypes_pb.Reference): void;

  clearCharacteristicList(): void;
  getCharacteristicList(): Array<Group.Characteristic>;
  setCharacteristicList(value: Array<Group.Characteristic>): void;
  addCharacteristic(value?: Group.Characteristic, index?: number): Group.Characteristic;

  clearMemberList(): void;
  getMemberList(): Array<Group.Member>;
  setMemberList(value: Array<Group.Member>): void;
  addMember(value?: Group.Member, index?: number): Group.Member;
...
export namespace Group {
  export type AsObject = {
    ...
    type?: Group.TypeCode.AsObject,
    actual?: proto_r4_core_datatypes_pb.Boolean.AsObject,
    code?: proto_r4_core_datatypes_pb.CodeableConcept.AsObject,
    name?: proto_r4_core_datatypes_pb.String.AsObject,
    quantity?: proto_r4_core_datatypes_pb.UnsignedInt.AsObject,
    managingEntity?: proto_r4_core_datatypes_pb.Reference.AsObject,
    characteristicList: Array<Group.Characteristic.AsObject>,
    memberList: Array<Group.Member.AsObject>,
  }

  export class TypeCode extends jspb.Message {
    getValue(): proto_r4_core_codes_pb.GroupTypeCode.ValueMap[keyof proto_r4_core_codes_pb.GroupTypeCode.ValueMap];
    setValue(value: proto_r4_core_codes_pb.GroupTypeCode.ValueMap[keyof proto_r4_core_codes_pb.GroupTypeCode.ValueMap]): void;
  ...
  export namespace TypeCode {
    export type AsObject = {
      value: proto_r4_core_codes_pb.GroupTypeCode.ValueMap[keyof proto_r4_core_codes_pb.GroupTypeCode.ValueMap],
  ...
  export class Characteristic extends jspb.Message {
    ...
    hasValue(): boolean;
    clearValue(): void;
    getValue(): Group.Characteristic.ValueX | undefined;
    setValue(value?: Group.Characteristic.ValueX): void;
  ...
  export namespace Characteristic {
    export type AsObject = {
      ...
      modifierExtensionList: Array<proto_r4_core_datatypes_pb.Extension.AsObject>,
      code?: proto_r4_core_datatypes_pb.CodeableConcept.AsObject,
      value?: Group.Characteristic.ValueX.AsObject,
  ...
  export class Member extends jspb.Message {
    ...
    hasEntity(): boolean;
    clearEntity(): void;
    getEntity(): proto_r4_core_datatypes_pb.Reference | undefined;
    setEntity(value?: proto_r4_core_datatypes_pb.Reference): void;
  ...
  export namespace Member {
    export type AsObject = {
      ...
      extensionList: Array<proto_r4_core_datatypes_pb.Extension.AsObject>,
      modifierExtensionList: Array<proto_r4_core_datatypes_pb.Extension.AsObject>,
      entity?: proto_r4_core_datatypes_pb.Reference.AsObject,
      period?: proto_r4_core_datatypes_pb.Period.AsObject,
