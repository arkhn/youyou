...
export class EvidenceVariable extends jspb.Message {
  ...
  getCharacteristicList(): Array<EvidenceVariable.Characteristic>;
  setCharacteristicList(value: Array<EvidenceVariable.Characteristic>): void;
...
export namespace EvidenceVariable {
  export type AsObject = {
    ...
    characteristicList: Array<EvidenceVariable.Characteristic.AsObject>,
  }
