...
// file: proto/r4/core/resources/payment_notice.proto
...
export class PaymentNotice extends jspb.Message {
  hasId(): boolean;
  clearId(): void;
  ...
  hasStatus(): boolean;
  clearStatus(): void;
  getStatus(): PaymentNotice.StatusCode | undefined;
  setStatus(value?: PaymentNotice.StatusCode): void;
  ...
  hasPayment(): boolean;
  clearPayment(): void;
  getPayment(): proto_r4_core_datatypes_pb.Reference | undefined;
  setPayment(value?: proto_r4_core_datatypes_pb.Reference): void;
  ...
  getPaymentStatus(): proto_r4_core_datatypes_pb.CodeableConcept | undefined;
  setPaymentStatus(value?: proto_r4_core_datatypes_pb.CodeableConcept): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PaymentNotice.AsObject;
  static toObject(includeInstance: boolean, msg: PaymentNotice): PaymentNotice.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: PaymentNotice, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PaymentNotice;
  static deserializeBinaryFromReader(message: PaymentNotice, reader: jspb.BinaryReader): PaymentNotice;
}

export namespace PaymentNotice {
  export type AsObject = {
    ...
    status?: PaymentNotice.StatusCode.AsObject,
    ...
    payment?: proto_r4_core_datatypes_pb.Reference.AsObject,
    ...
    paymentStatus?: proto_r4_core_datatypes_pb.CodeableConcept.AsObject,
  }
