...
// file: proto/r4/core/resources/research_definition.proto
...
export class ResearchDefinition extends jspb.Message {
  hasId(): boolean;
  clearId(): void;
  ...
  hasStatus(): boolean;
  clearStatus(): void;
  getStatus(): ResearchDefinition.StatusCode | undefined;
  setStatus(value?: ResearchDefinition.StatusCode): void;
  ...
  hasSubject(): boolean;
  clearSubject(): void;
  getSubject(): ResearchDefinition.SubjectX | undefined;
  setSubject(value?: ResearchDefinition.SubjectX): void;
  ...
  clearComment(): void;
  getComment(): Array<proto_r4_core_datatypes_pb.String>;
  setComment(value: Array<proto_r4_core_datatypes_pb.String>): void;
  ...
  toObject(includeInstance?: boolean): ResearchDefinition.AsObject;
  static toObject(includeInstance: boolean, msg: ResearchDefinition): ResearchDefinition.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ResearchDefinition, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResearchDefinition;
  static deserializeBinaryFromReader(message: ResearchDefinition, reader: jspb.BinaryReader): ResearchDefinition;
}

export namespace ResearchDefinition {
  export type AsObject = {
    ...
    status?: ResearchDefinition.StatusCode.AsObject,
    experimental?: proto_r4_core_datatypes_pb.Boolean.AsObject,
    subject?: ResearchDefinition.SubjectX.AsObject,
    ...
    comment: Array<proto_r4_core_datatypes_pb.String.AsObject>,
