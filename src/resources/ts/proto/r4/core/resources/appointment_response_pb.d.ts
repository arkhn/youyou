...
export class AppointmentResponse extends jspb.Message {
  ...
  clearParticipantType(): void;
  getParticipantType(): Array<proto_r4_core_datatypes_pb.CodeableConcept>;
  setParticipantType(value: Array<proto_r4_core_datatypes_pb.CodeableConcept>): void;
...
export namespace AppointmentResponse {
  export type AsObject = {
    ...
    participantType: Array<proto_r4_core_datatypes_pb.CodeableConcept.AsObject>,
