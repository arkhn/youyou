...
// file: proto/r4/fhirproto_extensions.proto
...
export class Base64BinarySeparatorStride extends jspb.Message {
  ...
  clearSeparator(): void;
  getSeparator(): proto_r4_core_datatypes_pb.String | undefined;
  setSeparator(value?: proto_r4_core_datatypes_pb.String): void;

  hasStride(): boolean;
  clearStride(): void;
  getStride(): proto_r4_core_datatypes_pb.PositiveInt | undefined;
  setStride(value?: proto_r4_core_datatypes_pb.PositiveInt): void;
...
export namespace Base64BinarySeparatorStride {
  export type AsObject = {
    id?: proto_r4_core_datatypes_pb.String.AsObject,
    separator?: proto_r4_core_datatypes_pb.String.AsObject,
    stride?: proto_r4_core_datatypes_pb.PositiveInt.AsObject,
  }
}
